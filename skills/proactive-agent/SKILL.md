...
description: >-
  Transform AI agents from task-followers into proactive partners that anticipate needs
  and continuously improve. Use PROACTIVELY when user says "proactive agent", "anticipate
  needs", "autonomous agent", "WAL protocol", "working buffer", "self-improving agent",
  "agent patterns", "proactive patterns", "continuous improvement", or "hal stack". Use
  when designing agents that should act ahead of requests.
