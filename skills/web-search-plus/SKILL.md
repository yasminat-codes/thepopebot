...
description: >-
  Unified web search with intelligent auto-routing across Serper, Tavily, Exa, and
  SearXNG. Use PROACTIVELY when user says "search the web", "look this up", "find
  recent info", "research this", "google this", "web search", "find news about",
  "search for", "look up", or any request for current information from the internet.
  Automatically selects the best search provider based on query type.
